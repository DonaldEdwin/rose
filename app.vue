<template>
  <!-- ========== HEADER ========== -->
  <header
    class="fixed top-0 inset-x-0 flex flex-wrap mt-6 md:justify-start md:flex-nowrap z-50 w-full before:absolute before:inset-0 before:max-w-5xl before:mx-2 lg:before:mx-auto before:rounded-md before:bg-neutral-800/30 before:backdrop-blur-md">
    <nav
      ...
      <div class="flex items-center">
        <!-- Logo -->
        <NuxtLink class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80"
          to="/" aria-label="Preline">
      ...
      <div id="hs-navbar-floating-dark"
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-end gap-y-3 py-2 md:py-0 md:ps-7">
          ...
          <NuxtLink
            class="pe-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-hidden focus:text-neutral-300"
            to="#">Services</NuxtLink>
          <NuxtLink
            class="pe-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-hidden focus:text-neutral-300"
            to="/ndis">NDIS</NuxtLink>
          <NuxtLink
            class="pe-3 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-hidden focus:text-neutral-300"
            to="/accomodations">Accomodations</NuxtLink>
    ...
    <div class="mt-aut m-2  rounded-md bg-neutral-900 w-full  py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <div class="col-span-full lg:col-span-3">
          <NuxtLink class="flex-none text-9xl font-semibold text-white focus:outline-hidden focus:opacity-80 heading" to="/"
            aria-label="Brand">Taley</NuxtLink>
        </div>
        <!-- End Col -->
        ...
        <div class="col-span-2">
          <div class="mb-2">
            ...
            <div class="mt-3 grid grid-cols-2 space-y-3 text-sm">
              <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 focus:outline-hidden focus:text-gray-800 "
                  href="#">Home</a></p>
              <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 focus:outline-hidden focus:text-gray-800"
                  href="#">About Us</a></p>
              <p><a class="inline-flex gap-x-2 text-white hover:text-gray-800 focus:outline-hidden focus:text-gray-800 "
            ...
            <div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2">
              <div class="w-full">
                ...
                <input type="text" id="hero-input" name="hero-input"
                  class="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                  placeholder="Enter your email">
              </div>
              <a class="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                href="#">
                Subscribe
              </a>
            </div>
