...
<div class="px-2 sm:px-6 lg:px-2">
  <div class="relative h-120 md:h-[100dvh] aspect-w-16 aspect-h-7 flex flex-col bg-[url('/assets/img/homeimg.jpg')] bg-cover bg-center bg-no-repeat rounded-2xl overflow-hidden">
    ...
    <div class="relative z-20 mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10">
...
<!-- End Features -->
 ...
 <!-- Grid -->
  <div class="mt-10 mb-5 sm:mt-20 grid grid-cols-3 md:grid-cols-3 items-center gap-2 sm:gap-3 lg:gap-3">
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
      ...
      <h2 class="text-2xl sm:text-3xl lg:text-4xl text-neutral-900 font-semibold">
        Our Services
      </h2>
    </div>
    <!-- End Title -->
